...
public class AlarmListAdapter extends ArrayAdapter<SingleAlarm> {
    ...
    private void setValuesInViewHolder(ViewHolder viewHolder, SingleAlarm singleAlarm, boolean isSelected) {
    ...
    public SingleAlarm getAlarm(int position) {
